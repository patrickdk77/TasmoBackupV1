...
?>
  <body>
    <div class="container-fluid">
      <center><h4><a href="index.php">TasmoBackup</a> - <?php echo t('Edit'); ?></h4></center>
    <table class="table table-striped table-bordered" id="status">
    <thead>
        <tr><th><b><?php echo t('NAME'); ?></th><th><?php echo t('IP'); ?></th><th><?php echo t('AUTH'); ?></th><th><?php echo t('SUBMIT'); ?></th></tr>
    </thead>
    <tbody>
...
<input type='hidden' name='oldip' value='<?php echo $ip; ?>'>
  ...
  <td><center><button type='submit' class='btn btn-sm btn-success'><?php echo t('Submit'); ?></button></center></td>
</form>
</tr>
<?php
        $relcount ++;
